...
Revision ID: 296478c27d07
Revises: 
Create Date: 2026-05-18 01:38:59.957968
...
def upgrade():
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('type_demandeur', sa.String(length=50), nullable=False),
    ...
    sa.Column('description', sa.Text(), nullable=True),
    sa.Column('statut', sa.String(length=50), nullable=False),
    sa.Column('dossier_complet', sa.Boolean(), nullable=True),
    sa.Column('date_creation', sa.DateTime(), nullable=True),
    ...
    sa.ForeignKeyConstraint(['demandeur_id'], ['demandeurs.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('supprimee', sa.Boolean(), nullable=True),
